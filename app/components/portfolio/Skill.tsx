    ...
    return (
        <div className="px-0 md:px-14">
            <div className="flex flex-row gap-2 items-center">
                <h1 id="skills" className={`${poppins.className} border border-4 border-yellow-500 font-bold text-2xl w-50 text-center mb-5`}>
                    Skills
                </h1>
            </div>
            {
                skill.map( (skill) => {
                    return (
                        <div className="flex flex-col items-start mb-10" key={skill.header}>
                            ...
                            >
                                <ul className="grid grid-cols-1 md:grid-cols-5 lg:grid-cols-8 gap-2">
