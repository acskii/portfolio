...
export default function NavBar() {
    ...
    return (
        <nav className="sticky top-0 z-50">
            <div className={`${poppins.className} max-w-screen bg-yellow-400 dark:bg-indigo-950 min-h-20 flex flex-row justify-between items-center px-8 py-5 relative`}>
                <div className="flex flex-row gap-1 items-center">
                    ...
                    <Link href="/" className={`${poppins.className} text-4xl font-black dark:text-white uppercase tracking-tighter`}>
                        Portfolio
                    </Link>
                </div>
